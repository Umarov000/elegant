  ...
  return (
    <section>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div>
            <h3 className="text-2xl md:text-3xl font-poppins tracking-[-0.6px] mb-3">
              Living Room
            </h3>
        ...
        <div
          className="px-8 py-10 bg-cover bg-center flex flex-col justify-end min-h-[250px] md:h-auto"
